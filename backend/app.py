...
neighborhood_en_to_ar = {
    ...
    "al nasim al gharbi": "النسيم الغربي",
...
# ===== الفئات التجارية (للدالة calculate_score) =====
categoryArabic = {
...
def chat():
    ...
    try:
        # ===== نجمع بيانات حقيقية من الموديل =====
        forsati_context = ""
 
        # نكشف إذا السؤال عن حي + فئة
        detected_nb  = None
        detected_cat = None
        ...
        # إذا عندنا حي + فئة، نحسب الـ score الحقيقي
...
"""
        ...
        # إذا عندنا فئة بس، نجيب أفضل 3 أحياء
...
"""
        ...
        # System prompt مع البيانات الحقيقية
